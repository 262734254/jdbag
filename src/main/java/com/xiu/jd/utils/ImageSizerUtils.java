...
public class ImageSizerUtils {
    ...
    public static void main(String[] args) throws Exception {
    	//http://images.xiustatic.com/upload/goods20110924/10001349/100013490001/g1_600_600.jpg
		String netWorkImagePath="http://www.xiustatic.com/static/img/default/default.400_400.jpg";
		byte b[]=HttUtils.getResponseData(netWorkImagePath);
		
		
		File originalFile=new File("g1_220_220.jpg");
	    FileOutputStream fos=new FileOutputStream(originalFile);
	    fos.write(b);
	    fos.close();
	    File resizedFile=new File("d:\\default.50_50.jpg");
		ImageSizerUtils.resize(originalFile, resizedFile, 200, "jpg");
