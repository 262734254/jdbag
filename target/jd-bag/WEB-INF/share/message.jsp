...
<html>
<link rel="stylesheet" href="<%=request.getContextPath() %>/template/css/message.css" type="text/css">
<body>
<div align="center">
<table>
<tr>
			  ...
			  <tr>
				<td width="288" align="center" bgcolor="#C2E1FE"><table width="100" border="0" cellpadding="0" cellspacing="0">
					...
					<table width="273" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
					  <tr>
						<td width="240" height="50" align="center" valign="bottom" class="font12">
							<p>	
					  ...
					  <tr>
						<td height="80" align="center" valign="middle"><font size="2"><span class="content">
						 ...
						 onclick="javascript:window.location.href='${redirectUrl}'"
						 >
						</span></font></td>
					  </tr>
					</table>
