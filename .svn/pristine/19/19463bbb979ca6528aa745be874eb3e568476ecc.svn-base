...
<fieldset class="clearfix adminSearch">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					  <td><img src="<%=request.getContextPath()%>/template/images/gobal_failure.png"/>&nbsp;<strong><s:property value="xopResult.resultMessage" /></strong></td>
				 </tr>
				 <tr>
					  <td></td>
				</tr>
				<tr>
					  <td><s:property value="xopResult.errorMessage" /></td>
				</tr>
			</table>
</fieldset>
</div>
